...
public class StockBhavUploadProcessor extends Processor {

    private static final Logger logger = LoggerFactory.getLogger(StockBhavUploadProcessor.class);
    private boolean isRunning;

    private StockBhavUploadProcessor(){}

    private static class Impl
    {
        private static final StockBhavUploadProcessor INSTANCE = new StockBhavUploadProcessor();
    }
